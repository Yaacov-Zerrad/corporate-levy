...
const Header:FunctionComponent = () => {
  ...
  <section id="hero" className="d-flex flex-column justify-content-center">
    <div className="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Rivka Levy</h1>
      <p><span className="typed" data-typed-items="Designer, Developer, Freelancer, Photographer">Praticienne</span>	&nbsp;<span className="descr-serv"style={{color:'#45505b', fontStyle: 'italic'}}>Hypnose, Neuro-feedback, NFT </span></p>
